...
public class PreExamDAO {
    ...
    private static final String URL ="jdbc:h2:~/h2db/db_prac;Mode=PostgreSQL;AUTO_SERVER=TRUE;;MV_STORE=false";
            //"jdbc:h2:~/h2db/db_prac;Mode=PostgreSQL;AUTO_SERVER=TURE";
    private static final String USER_NAME ="b2220880";
    private static final String USER_PASS = "b2220880";
